                ...
                GestureDetector(
                    child: Container(
                      ...
                      margin: EdgeInsets.fromLTRB(
                          100, 0, doubleTapLWidthFS / 2 + 30, 40),
            ...
            children: <Widget>[
              ...
              Container(
                margin: EdgeInsets.only(
                    top: videoHeight - 70, left: videoMargin + 5),
                child: IconButton(
                    ...
                    icon: _controller.value.isPlaying
                        ...
                        : Icon(Icons.play_arrow,
                            ...
                            color: Color.fromARGB(255, 237, 28, 36)),
                    onPressed: () {
                      print("Icon button on pressed method ran");
                      setState(() {
              ...
              //           size: 26.0, color: Color.fromARGB(255, 237, 28, 36)),
              //       onPressed: () {
