...
//Класс видео плеера
class VimeoPlayerNoFullScreen extends StatefulWidget {
  final String id;
  final bool autoPlay;
  final bool looping;
  final int position;
  ...
  @override
  _VimeoPlayerNoFullScreenState createState() =>
      _VimeoPlayerNoFullScreenState(id, autoPlay, looping, position);
}

class _VimeoPlayerNoFullScreenState extends State<VimeoPlayerNoFullScreen> {
  String _id;
  bool autoPlay = false;
  bool looping = false;
  bool _overlay = true;
  ...
  _VimeoPlayerNoFullScreenState(
      this._id, this.autoPlay, this.looping, this.position);
              ...
              Container(
                ...
                child: IconButton(
                    ...
                    onPressed: () {
                      setState(() {
                        print(
                            "Position at play/pause: ${_controller.value.position.inSeconds}");
                        if (_controller.value.isPlaying) {
                          Amplitude.getInstance(
                                  instanceName:
                                      Constants.AMPLITUDE_INSTANCE_NAME)
                              .logEvent(
                                  "Vimeo No Full Screen Player Pause Button Clicked",
                                  eventProperties: {
                          ...
                          Amplitude.getInstance(
                                  instanceName:
                                      Constants.AMPLITUDE_INSTANCE_NAME)
                              .logEvent(
                                  "Vimeo No Full Screen Player Play Button Clicked",
                                  eventProperties: {
                                "video_timestamp_seconds":
                                    _controller.value.position.inSeconds,
                                "vimeo_id": this.widget.id
